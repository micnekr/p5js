...
let text = {
  ...
  "robot": "saw a robot there.\n As #hero# was good at programming, he changed the robot`s programm to find #name#`s #second#.\n The robot completed the task in less than a #time#. The #hero# was so #happy#, so he made the robot tell others his story. He also was shy, so he changed something in it.\n\n#start#",
